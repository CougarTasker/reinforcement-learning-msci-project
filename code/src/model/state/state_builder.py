...
class StateBuilder(object):
    ...
    def set_agent_location(self, pos: tuple[int, int]):
        ...
        Returns:
            StateBuilder: the builder to continue chaining methods
        """
    ...
    def decrement_energy(self, amount=1):
    ...
    def set_entity(self, cell: tuple[int, int], entity: CellEntity):
    ...
    def remove_entity(self, cell: tuple[int, int]):
