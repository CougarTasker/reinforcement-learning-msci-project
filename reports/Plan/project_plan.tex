...
\begin{abstract}
  ...
  The program will be developed in Python; this is motivated by Python's strong ecosystem of tooling and community for data processing tasks. Performance is essential with machine learning tasks\cite{raschka2020machine}. Python enables the use of low-level libraries that can use the hardware efficiently with high-level APIs\cite{raschka2020machine}. These high-level APIs abstract over unimportant details, increasing productivity\cite{raschka2020machine}. However, Raschka et al. states:
