...
\begin{abstract}
  ...
  Autonomous systems are becoming integral to modern society\cite{zaouter2020autonomous}. Within this context, this project seeks to address a pressing challenge: the efficient utilisation of resources by autonomous robots operating in dynamic environments.

  The motivation for this project stems from the increasing prevalence of autonomous robots across various domains, such as drones and Boston-dynamic's Spot. As these robots take on more complex tasks, optimising their resource consumption, particularly energy, becomes paramount.
  
  The primary objective is to develop and evaluate reinforcement learning algorithms in a simulated grid world environment where a robot must navigate, make decisions, and gather resources while managing its energy reserves. This project intends to achieve the following goals:
  \begin{itemize}
    ...
    \item Scalable Learning: Develop reinforcement learning algorithms that enable the robot to learn and adapt to different grid world scenarios and environmental changes. The system should demonstrate scalability and the ability to generalise knowledge across diverse grid layouts and resource distributions.
  \end{itemize}
