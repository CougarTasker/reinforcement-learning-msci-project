...
When starting the application you will be greeted by a window that is largely broken into three parts. At the top, there is a section which has the main controls for selecting the major options such as the dynamics, agent and if the agent is off-policy you can select its exploration strategy. 
