...
\cite{LLMSocialEthicalRisks}

\cite{legislatingRekognition}
\cite{facialRecognitionEthicsSurvay}
\cite{rekognitionOverview} -- done 
case study:

facial recognition biases and inaccuracies particularly in identifying individuals from different demographic groups

2018  (Amazon's facial recognition tool "Rekognition") had been used by law enforcement agencies. 
