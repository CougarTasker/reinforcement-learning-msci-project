...
Pipx is simple build frontend that should be familiar if you have experience with pip. You can find instructions on how to \href{https://pipx.pypa.io/stable/installation/}{install pipx for your platform here}. If you have installed pipx you can run the application with the following command:
