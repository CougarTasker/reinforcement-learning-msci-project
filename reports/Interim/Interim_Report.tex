...
This application has been written in Python with The model-view-controller architecture. The application has been written in an object-oriented fashion with modern software engineering principles in mind\cite{van2008software}. This application uses Pytest to guarantee all core, complex, and important functionality. I made this choice based upon my experience from my year in industry that testing can be incredibly valuable in many places 100\% coverage or TDD can be counterproductive with, diminishing returns for trivial code, increased baggage with refactoring and sometimes the tests become more complex and bug-prone than the code they are testing.
